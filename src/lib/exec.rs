...
pub fn running_containers(_exec: &str, running_containers: Vec<RunningContainerStatus>) {
...
pub fn stopped_containers(_exec: &str, stopped_containers: Vec<StoppedContainerStatus>) {
